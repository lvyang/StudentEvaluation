...
const float NJKInitialProgressValues = 0.1f;
const float NJKInteractiveProgressValues = 0.5f;
const float NJKFinalProgressValues = 0.9f;
...
- (void)startProgress
{
    if (_progress < NJKInitialProgressValues) {
        [self setProgress:NJKInitialProgressValues];
    }
}
...
- (void)incrementProgress
{
    ...
    float maxProgress = _interactive ? NJKFinalProgressValues : NJKInteractiveProgressValues;
